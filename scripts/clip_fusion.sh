...
--V_type=denseface --input_dim_v=342 --embd_size_v=512  --embd_method_v=maxpool
--L_type=bert_large --input_dim_l=1024 --embd_size_l=512
...
--name=clip_fusion --suffix={modality}_run{run_idx} --has_test
--cvNo=$i"
